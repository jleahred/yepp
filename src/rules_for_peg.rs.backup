...
pub(crate) fn rules() -> parser::expression::SetOfRules {
    rules!(
       ...
       , r#"just_andline"# => or!(and!(ref_rule!(r#"andline"#), rep!(or!(and!(transf2!( and!( and!(ref_rule!(r#"_eol"#), rep!(ref_rule!(r#"eol"#), 0), ref_rule!(r#"_"#)) ) , t2rules!(t2_funct!("none"), ) ), ref_rule!(r#"no_rule_name"#), ref_rule!(r#"and"#))), 0, 1)))
       ...
       , r#"andline_transf2"# => or!(and!(transf2!( and!( and!(or!(and!(ref_rule!(r#"andline"#), ref_rule!(r#"transf2"#), named!("and", rep!(or!(and!(transf2!( and!( and!(ref_rule!(r#"_"#)) ) , t2rules!(t2_funct!("none"), ) ), ref_rule!(r#"no_rule_name"#), ref_rule!(r#"and"#))), 0, 1))))) ) , t2rules!(t2_text!("TRANSF2"), t2_funct!("endl"), t2_byname!("transf2"), t2_text!("EOTRANSF2"), t2_funct!("endl"), t2_text!("AND"), t2_funct!("endl"), t2_byname!("andline"), t2_text!("CLOSE_MEXPR"), t2_funct!("endl"), t2_byname!("and"), ) )))
       ...
       , r#"dot"# => or!(and!(lit!(".")))
       , r#"no_rule_name"# => or!(and!(not!(or!(and!(ref_rule!(r#"rule_name"#), ref_rule!(r#"_"#), lit!("="))))))
       ...
       , r#"and"# => or!(and!(ref_rule!(r#"error"#)), and!(ref_rule!(r#"andline_transf2"#)), and!(ref_rule!(r#"just_andline"#)))
