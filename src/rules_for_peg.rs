...
rules!(
       ...
       , r#"just_andline"# => or!(and!(ref_rule!(r#"andline"#), rep!(or!(and!(transf2!( and!( and!(ref_rule!(r#"_eol"#), rep!(ref_rule!(r#"eol"#), 0), ref_rule!(r#"_"#)) ) , t2rules!(t2_funct!("none"), ) ), or!(and!(ref_rule!(r#"no_rule_name"#), not!(ref_rule!(r#"rule_descr"#)))), ref_rule!(r#"and"#))), 0, 1)))
       ...
       , r#"dot"# => or!(and!(lit!(".")))
       , r#"rule_descr"# => or!(and!(transf2!( and!( and!(ref_rule!(r#"_"#), lit!(".desc"), named!("desc", rep!(or!(and!(not!(lit!("desc.")), dot!())), 0)), lit!("desc."), ref_rule!(r#"_"#)) ) , t2rules!(t2_byname!("desc"), ) )))
       , r#"rule"# => or!(and!(transf2!( and!( and!(ref_rule!(r#"_"#), ref_rule!(r#"rule_name"#), ref_rule!(r#"_"#), lit!("="), ref_rule!(r#"_"#), ref_rule!(r#"expr"#), ref_rule!(r#"_eol"#), ref_rule!(r#"_"#), named!("desc", rep!(ref_rule!(r#"rule_descr"#), 0, 1))) ) , t2rules!(t2_text!("RULE"), t2_funct!("endl"), t2_byname!("rule_name"), t2_funct!("endl"), t2_text!("DESCR"), t2_funct!("endl"), t2_byname!("desc"), t2_funct!("endl"), t2_byname!("expr"), ) )))
