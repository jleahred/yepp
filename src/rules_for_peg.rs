...
rules!(
       ...
       , r#"rule_descr"# => or!(and!(transf2!( and!( and!(ref_rule!(r#"_"#), lit!(".desc"), ref_rule!(r#"_"#), named!("desc", not!(or!(and!(lit!("desc."), dot!())))), ref_rule!(r#"_"#), lit!("desc."), ref_rule!(r#"_"#)) ) , t2rules!(t2_text!("RDESC"), t2_funct!("endl"), t2_byname!("desc"), ) )))
       ...
       , r#"rule"# => or!(and!(transf2!( and!( and!(ref_rule!(r#"_"#), ref_rule!(r#"rule_name"#), ref_rule!(r#"_"#), lit!("="), ref_rule!(r#"_"#), ref_rule!(r#"expr"#), ref_rule!(r#"_eol"#), ref_rule!(r#"_"#), rep!(ref_rule!(r#"rule_descr"#), 0, 1), ref_rule!(r#"_"#)) ) , t2rules!(t2_text!("RULE"), t2_funct!("endl"), t2_byname!("rule_name"), t2_funct!("endl"), t2_byname!("expr"), ) )))
